...
bool StrokeWidth1::TestVerticalTextDirection1(double find_vertical_text_ratio1,
                                            TO_BLOCK* block1,
                                            BLO_CLIST* osd_blobs1) {
  int vertical_boxes1 = 0;
  int horizontal_boxes1 = 0;
  BLO_CLIST vertical_blobs;
  BLO_CLIST horizontal_blobs;
  int i = 0;
  BLO_CLIST nondescript_blobs;
  ...
  if (osd_bls != nullptr && vertical_boxes == 0 && horizontal_boxes == 0) {
    BLOBNBOX_C_IT osd_it(osd_bls);
    int i = 0;
