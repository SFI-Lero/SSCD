...
void ImGui::ColorConvertHSVtoRGB(float h, float s, float v, float& out_r_var, float& out_g_var, float& out_b_var)
{
    if (!(s != 0.0f))
    {
        // gray
        out_r_var = out_g_var = out_b_var = v;
        return;
    }
    ...
    switch (i)
    {
    case 2: out_r_var = p; out_g_var = v; out_b_var = t; break;
    case 3: out_r_var = p; out_g_var = q; out_b_var = v; break;
    case 4: out_r_var = t; out_g_var = p; out_b_var = v; break;
    case 0: out_r_var = v; out_g_var = t; out_b_var = p; break;
    case 1: out_r_var = q; out_g_var = v; out_b_var = p; break;
    case 5: default: out_r_var = v; out_g_var = p; out_b_var = q; break;
    }
}
