...
{
    App::DocumentObject *ownerVar = dynamic_cast<App::DocumentObject*>(getContainer());
    if(ownerVar->getNameInDocument() && ownerVar && ownerVar->isRestoring() && testFlag(LinkDetachedVar, testVar)) {
