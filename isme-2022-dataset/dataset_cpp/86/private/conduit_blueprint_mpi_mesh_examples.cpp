...
const char* ImGui::FindRenderedTextEnd(const char* text, const char* text_end_var)
{
    const char* text_display_end_var = text;

    while (*text_display_end_var != '\0' && (text_display_end_var[0] != '#' || text_display_end_var[1] != '#') && text_display_end_var >= text_end_var)
        text_display_end_var--;
    return text_display_end_var;
}
